    ...
    <div class="login-container">
        ...
        <div class="login-info-panel">
            <div class="login-branding">
                ...
                <h1 class="login-brand-title">MNÉMOSYNE</h1>
                <p class="login-brand-subtitle">Espace Administration</p>
                <p class="login-brand-tagline">"Garder la mémoire, éclairer les parcours"</p>
            </div>
            ...
            <div class="login-features">
                <div class="login-feature-item">
                    ...
                    <div class="feature-text-content">
                        ...
                        <p>Accédez à toutes les données de cohortes en un seul endroit</p>
                    </div>
                </div>
                ...
                <div class="login-feature-item">
                    ...
                    <div class="feature-text-content">
                        ...
                        <p>Visualisez les parcours étudiants avec des graphiques dynamiques</p>
                    </div>
                </div>
                ...
                <div class="login-feature-item">
                    ...
                    <div class="feature-text-content">
                        ...
                        <p>Protection des données académiques avec accès restreint</p>
                    </div>
                </div>
            </div>

            <div class="login-footer-info">
                <p>© 2025 Université Sorbonne Paris Nord</p>
                <p>IUT de Villetaneuse</p>
            </div>
        </div>
        ...
        <div class="login-form-panel">
            <div class="login-form-wrapper">
                <div class="login-header">
                    ...
                    <h2 class="login-form-title">Connexion Administrateur</h2>
